...
class DietsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get new" do
    get new_ficha_dieta_url(@diet.ficha_id)
    assert_response :success
  end
  ...
  test "should create diet" do
    ...
    assert_redirected_to ficha_dieta_url(@diet.ficha_id, Diet.last)
  end

  test "should show diet" do
    get ficha_dieta_url(@diet.ficha_id, @diet)
    assert_response :success
  end

  test "should get edit" do
    get edit_ficha_dieta_url(@diet.ficha_id, @diet)
    assert_response :success
  end

  test "should update diet" do
    patch ficha_dieta_url(@diet.ficha_id, @diet), params: { diet: { calorias: @diet.calorias, carboidratos_g: @diet.carboidratos_g, descricao: @diet.descricao, gordura_g: @diet.gordura_g, proteina_g: @diet.proteina_g, refeicao: @diet.refeicao } }
    assert_redirected_to ficha_dieta_url(@diet.ficha_id, @diet)
  end

  test "should destroy diet" do
    assert_difference("Diet.count", -1) do
      delete ficha_dieta_url(@diet.ficha_id, @diet)
    end
