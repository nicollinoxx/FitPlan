...
class DietsTest < ApplicationSystemTestCase
  ...
  test "should create diet" do
    ...
    fill_in "Calorias", with: @diet.calorias
    fill_in "Carboidratos g", with: @diet.carboidratos_g
    fill_in "Descricao", with: @diet.descricao
    fill_in "Gordura g", with: @diet.gordura_g
    fill_in "Proteina g", with: @diet.proteina_g
    fill_in "Refeicao", with: @diet.refeicao
